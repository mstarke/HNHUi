...
#define BADGE_BACKGROUND_COLOR [NSColor colorWithRed:0.588 green:0.647 blue:0.706 alpha:1.0]
...
- (void)_drawBadgeWithCount:(NSInteger)count inFrame:(NSRect)badgeFrame;
{
  ...
  NSColor *badgeColor = isSelected ? [NSColor colorWithRed:0.588 green:0.647 blue:0.706 alpha:1.0] : [NSColor whiteColor];
