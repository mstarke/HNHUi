...
//! Project version number for HNHUi.
FOUNDATION_EXPORT double HNHUiVersionNumber;

//! Project version string for HNHUi.
FOUNDATION_EXPORT const unsigned char HNHUiVersionString[];
